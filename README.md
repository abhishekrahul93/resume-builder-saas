...
- `/revenuepulse` - RevenuePulse, a recruiter-facing AI revenue analytics platform with SaaS KPIs, data-quality checks, anomaly detection, grounded copilot answers, evaluation signals, and AI insight reports
...
- Grounded AI copilot questions with source cards, caveats, recommended actions, and answer-quality evaluation
...
- `app/revenuepulse/page.tsx` - live dashboard, AI copilot, evaluation panel, and insight report UI
